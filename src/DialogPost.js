...
function DialogPost({open,setOpen}) {
        ...
        <Dialog open={open} onClose={()=>setOpen(false)}>
            ...
            <div className="dialog__post__body">
                ...
                <div className="dialog__input__body">
                    <textarea type="text" placeholder="Whats on your Mind"/>
                </div>
